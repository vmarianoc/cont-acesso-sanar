      ...
      <main className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Envie o relatório "Contatos das unidades" em PDF, ou uma planilha CSV/Excel com uma
            linha por ocupante. A pré-visualização não grava nada — os dados só são salvos ao
            confirmar.
          </p>
